...
var varPageUrl='http://www.mysqltutorial.org/mysql-self-join/';
var callForPixel = 1;
var varTmxOpx = 0;
...
function TMX_Default(platform) { 
  ...
  if ('PSA'=='PASSBACK') {
    ...
    document.write('<script type="text/javascript" src="//uat-net.technoratimedia.com/pixel?rid=2060258058372534&id=4&bid=' + platform + '"></scr' + 'ipt>');
  } else {
    ...
    document.write('<script type="text/javascript" src="//uat-net.technoratimedia.com/pixel?rid=2060258058372534&id=3&bid=' + platform + '"></scr' + 'ipt>');
  }
}
function TMX_OpenX(auid) {
  ...
  document.write("		src=\"\/\/uat-net.technoratimedia.com\/pixel?rid=2060258058372534&id=2&typ=apndef&bid=OPX&sid=20721&cp=' + a.getProperties().pub_rev + '\">");
...
function TMX_DefaultOrPSA(platform) { 
  if ('PSA'=='PASSBACK') {
    ...
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=2060258058372534&id=4&bid=' + platform + '"></scr' + 'ipt>');
  } else {
    document.write('<scr' + 'ipt type="text/javascript" src="' + (tmIsSecure ? 'https://uat-net' : 'http://ad-cdn') + '.technoratimedia.com/psa/psa.js' +'"></scr' + 'ipt>');
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=2060258058372534&id=3&bid=' + platform + '"></scr' + 'ipt>');
  }
}
function displayAds() {
	TMX_Default();
...
function TMX_Return() {
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=2060258058372534&id=7"></scr' + 'ipt>');
	TMX_APN('1');
}
...
if(window.varPixel91==undefined){document.write('<scr' + 'ipt src="//securepaths.com/js/implement.js?org=6riy0wxbcK1Akn8fjYxw&s=2060258058372534&p=10665&a=20721&cmp=CampaignID&fmt=banner&rt=display&sl=1"></scr'+ 'ipt>');	var varPixel91=1;}if(window.varPixel97==undefined){if (document.location.protocol == 'http:') {
