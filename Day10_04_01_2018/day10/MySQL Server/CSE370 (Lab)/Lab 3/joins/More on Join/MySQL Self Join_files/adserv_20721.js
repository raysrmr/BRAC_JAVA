...
var vartmsf =  parseFloat('0.195').toFixed(2);
...
function TMX_Default(platform) { 
  ...
  if ('PSA'=='PASSBACK') {
    ...
    document.write('<script type="text/javascript" src="//uat-net.technoratimedia.com/pixel?rid=2060257771716903&id=4&bid=' + platform + '"></scr' + 'ipt>');
  } else {
    ...
    document.write('<script type="text/javascript" src="//uat-net.technoratimedia.com/pixel?rid=2060257771716903&id=3&bid=' + platform + '"></scr' + 'ipt>');
  }
}
function TMX_OpenX(auid) {
  ...
  document.write("		src=\"\/\/uat-net.technoratimedia.com\/pixel?rid=2060257771716903&id=2&typ=apndef&bid=OPX&sid=20721&cp=' + a.getProperties().pub_rev + '\">");
...
function TMX_DefaultOrPSA(platform) { 
  if ('PSA'=='PASSBACK') {
    ...
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=2060257771716903&id=4&bid=' + platform + '"></scr' + 'ipt>');
  } else {
    document.write('<scr' + 'ipt type="text/javascript" src="' + (tmIsSecure ? 'https://uat-net' : 'http://ad-cdn') + '.technoratimedia.com/psa/psa.js' +'"></scr' + 'ipt>');
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=2060257771716903&id=3&bid=' + platform + '"></scr' + 'ipt>');
  }
}
function displayAds() {
	TMX_Default();
...
function TMX_Return() {
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=2060257771716903&id=7"></scr' + 'ipt>');
	TMX_APN('1');
}
